...
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Hana and Alice (Hana to Arisu)', 'Duis consequat dui nec nisi volutpat eleifend. Donec ut dolor. Morbi vel lectus in quam fringilla rhoncus.', '01/02/2019', '11/13/2019', '03/05/2020');
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Come Out and Play', 'Suspendisse potenti. In eleifend quam a odio. In hac habitasse platea dictumst.', '01/02/2019', '11/15/2019', '12/08/2019');
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Very Natural Thing, A', 'In hac habitasse platea dictumst. Etiam faucibus cursus urna. Ut tellus.', '01/02/2019', '12/20/2019', '03/29/2020');
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Main Prem Ki Diwani Hoon', 'Fusce lacus purus, aliquet at, feugiat non, pretium quis, lectus. Suspendisse potenti. In eleifend quam a odio.', '01/02/2019', '07/10/2020', '06/21/2020');
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Rocket Science', 'Morbi quis tortor id nulla ultrices aliquet. Maecenas leo odio, condimentum id, luctus nec, molestie sed, justo. Pellentesque viverra pede ac diam.', '01/02/2019', '12/14/2019', '07/09/2020');
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Pete''s Dragon', 'Aliquam quis turpis eget elit sodales scelerisque. Mauris sit amet eros. Suspendisse accumsan tortor quis turpis. Sed ante.', '01/02/2019', '01/09/2020', '10/19/2019');
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'New York Doll', 'Etiam faucibus cursus urna. Ut tellus. Nulla ut erat id mauris vulputate elementum. Nullam varius. Nulla facilisi.', '01/02/2019', '10/17/2019', '01/24/2020');
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Casey Jones', 'Morbi sem mauris, laoreet ut, rhoncus aliquet, pulvinar sed, nisl. Nunc rhoncus dui vel sem.', '01/02/2019', '05/23/2020', '04/08/2020');
...
insert into projects ( name, description, start_date, deadline, completion_date) values ( 'Killjoy 3', 'Nulla tempus. Vivamus in felis eu sapien cursus vestibulum. Proin eu mi.', '01/02/2019', '06/16/2020', '11/03/2019');
