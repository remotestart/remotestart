package com.capstone.remotestart;

import com.capstone.remotestart.services.UserDetailsLoader;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .authorizeRequests()
                .antMatchers("/") // anyone can see the landing page
                .permitAll()
                ...
                .antMatchers(
                        ...
                        "project", "/project/*" //only authenticated users can see projects
                )
                .authenticated()
        ;
    }
